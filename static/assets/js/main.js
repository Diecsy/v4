...
if(window.location.pathname === "/index.html" || window.location.pathname === "/") {
  ...
  const options = ["Free T Kay", "Von did nothing wrong", "Free R Kelly", "Diddy was right", "REAL HAUNTOHOLICS", "Sematary Rocking With Ghost Mountain", "You can go onto any site, like fr", "Mr. Eccles never sees me on my phone.", "dont share this link or we are all cooked af", "tray please dont search bbc again", "trenton is retarded" ];
